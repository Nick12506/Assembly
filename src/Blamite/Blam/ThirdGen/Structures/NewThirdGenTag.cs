...
{
	public class NewThirdGenTag : ITag
	{
		...
		public NewThirdGenTag(StructureValueCollection values, ushort index, FileSegmentGroup metaArea,
		...
		public uint VirtualAddr { get; set; }

		public StructureValueCollection Serialize(IList<ITagClass> classList)
		{
			var result = new StructureValueCollection();
			result.SetInteger("memory address", (MetaLocation != null) ? VirtualAddr : 0);
